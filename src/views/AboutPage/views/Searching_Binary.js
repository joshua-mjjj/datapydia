    ...
    <Card className={classes.root}>
      ...
      <CardContent>
        <Typography variant="body2" color="textSecondary" component="p">
          Binary Search is a searching algorithm for finding an element's position in a sorted array.The element is always searched in the middle of a portion of an array and can be implemented only on a sorted list of items.
        </Typography>
      </CardContent>
